...
def edit_input_to_number_of_groups(input, number_of_groups):
    ...
    if number_of_groups==4 or number_of_groups==12:
        ...
        if number_of_groups==4:          
            ...
            0,                      0,                      0,                      0,                      0,                      0,                      0]
            input["B"][0]= [
            15.5, 15.5, 15.5, 15.5, 13.7, 13.7, 13.7,
            15.5, 15.5, 15.5, 15.5, 13.7, 13.7, 13.7,
            15.5, 15.5, 15.5, 15.5, 13.7, 13.7, 13.7,
            15.5, 15.5, 15.5, 15.5, 13.7, 13.7, 13.7] 
            input["B"][1]= [
            3.2, 3.2, 3.2, 3.2, 1.7,  1.7,  1.7,
            3.2, 3.2, 3.2, 3.2, 1.7,  1.7,  1.7,
            3.2, 3.2, 3.2, 3.2, 1.7,  1.7,  1.7,
            3.2, 3.2, 3.2, 3.2, 1.7,  1.7,  1.7]    
            
            for d in range(input["nDays"]):
                input["B"][0][d]= input["B"][0][d]*1.19 
                input["B"][1][d]= input["B"][1][d]*1.19   
        if number_of_groups==12:
            input["B"][0]= [
            15, 15, 15, 15, 11.2, 11.2, 11.2,
            15, 15, 15, 15, 11.2, 11.2, 11.2,
            15, 15, 15, 15, 11.2, 11.2, 11.2,
            15, 15, 15, 15, 11.2, 11.2, 11.2]  
            input["B"][1]= [
            3.1, 3.1, 3.1, 3.1, 1.7,  1.7,  1.7,
            3.1, 3.1, 3.1, 3.1, 1.7,  1.7,  1.7,
            3.1, 3.1, 3.1, 3.1, 1.7,  1.7,  1.7,
            3.1, 3.1, 3.1, 3.1, 1.7,  1.7,  1.7]
            input["Y"][0]= [
        ...
        if number_of_groups==5:
            input["B"][0]= [
            14.5, 14.5, 14.5, 14.5, 10.8, 10.8, 10.8,
            14.5, 14.5, 14.5, 14.5, 10.8, 10.8, 10.8,
            14.5, 14.5, 14.5, 14.5, 10.8, 10.8, 10.8,
            14.5, 14.5, 14.5, 14.5, 10.8, 10.8, 10.8] 
            input["B"][1]= [
        ...
        if number_of_groups==13:
            input["B"][0]= [
            15, 15, 15, 15, 13.3, 13.3, 13.3,
            15, 15, 15, 15, 13.3, 13.3, 13.3,
            15, 15, 15, 15, 13.3, 13.3, 13.3,
            15, 15, 15, 15, 13.3, 13.3, 13.3] 
            input["B"][1]= [
            2.4, 2.4, 2.4, 2.4, 1.3,  1.3,  1.3, 
            2.4, 2.4, 2.4, 2.4, 1.3,  1.3,  1.3, 
            2.4, 2.4, 2.4, 2.4, 1.3,  1.3,  1.3, 
            2.4, 2.4, 2.4, 2.4, 1.3,  1.3,  1.3]
            input["Y"][0]= [ 
