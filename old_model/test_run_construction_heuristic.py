...
def main(number_of_groups: int,flexibility: float, nScenarios: int, seed: int):
    try:
        ...
        results, input          =   run_model_mip(input,flexibility,40,expected_value_solution=False,print_optimizer = True)
    ...
    run_greedy_construction_heuristic(input,results,debug=True)
